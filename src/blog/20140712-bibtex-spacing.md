...
If you use LaTeX and want to adjust the spacing between each item in your bibliography, then download [[{{filesdir}}/bibspacing.sty|bibspacing.sty]] and put the following in your document:
```tex
...
## Alternate approach.
**Alternately,** if you don't want to download [[{{filesdir}}/bibspacing.sty|bibspacing.sty]], you can just include it's contents into the **preamble** of your LaTeX source:
{% raw %}
```tex
