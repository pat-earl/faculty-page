title: Static Jinja2 Site Generator
summary: I recently rewrote my website using [staticjinja](http://staticjinja.readthedocs.org/en/latest/), a static site generator. This is what [my website](http://www.math.cmu.edu/~gautam) looks like and [here](https://gitlab.com/gi1242/sjinja-www) is the source code. The features / setup-instructions are described below.
...
* Site specific markdown extensions and macros can be found [[{{filesdir}}/local-extensions.md|here]].
