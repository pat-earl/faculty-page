...
* To specify the link text use `[[/index.html|Test]]`, which links to `/index.html` and says `Test`. This renders like this: [[/index.html|Test]]
...
* A few variables are injected into the Jinja2 context, and can be accessed in
  Jinja2 commands
