...
* [Lecture Notes on Multivariable Calculus](https://www0.maths.ox.ac.uk/system/files/coursematerial/2015/3063/3/mvc.pdf) by Barbara Niethammer and Andrew Dancer.
    <small>(This covers the differential calculus portion of this class.)</small>
* [[pdfs/giovanni-2015.pdf|Lecture notes]] by Giovanni Leoni.
...
* Your overall grade will be computed as a weighted average with your final counting for 50%, your better midterm 30% and homework 20%, with homework grade capped by the exam average.
    - Explicitly, your exam average *E* is computed using *E = (5F + 3 max(M1, M2)) / 8*, where *F*, *M1* and *M2* are your final and midterm grades respectively.
    - Now your overall grade *A* given by *A = .8E + .2 min(H, E)*, where *H* is your homework grade.
    - In particular, this means that the midterm you do worse in will not count towards your grade.
