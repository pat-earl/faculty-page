...
**You are not required to do a project plan for this project.**

## Setup and Submission

As you've done in the past two projects, you should copy this directory:

`~earl/public/csc135/projects/project3/`

in to your csc135 directory. There will be a file named `project3.cpp`, where you should put all
your code for this project.

When you are ready to submit, type `make submit` in the project directory.