...
2. Analysis – list the following:
    1. Inputs - What data is your program collecting?
    2. Outputs - What data is your program outputting?
    3. Constants - What data is not going to change?
    4. Formulas - Mathematical formulas that will be used.
    5. Constraints - Enforced by your program. (Program will *enforce* the user to enter a number greater than zero.)
    6. Assumptions - Not enforced by your program. (Program will *assume* the user will provide valid input.)
